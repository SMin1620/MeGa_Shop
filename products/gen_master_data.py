...
# 상품의 정보 생성 ( 더미 데이터 )
def gen_product(
        market_id: int, name: str, display_name: str, price: int, opt_1_names: tuple[str, ...],
        is_hidden: bool, is_sold_out: bool, hit_count: int, review_count: int, review_point: int
) -> None:
    ...
    product = Product(
        market_id=market_id, name=name, display_name=display_name,
        price=price, sale_price=price - price//10, category_id=category_id,
        is_hidden=is_hidden, is_sold_out=is_sold_out, hit_count=hit_count,
    ...
    for opt_1_name in opt_1_names:
        ...
        for opt_2_index, opt_2_name in enumerate(opt_2_names):
            ...
            ProductReal(
                product=product, option_1_name=opt_1_name, option_1_display_name=opt_1_display_name,
                option_2_name=opt_2_name, option_2_display_name=opt_2_display_name
            ).save()
